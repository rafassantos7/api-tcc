...
class UsuarioRepositoryTest {
    ...
    void encontrarUsuarioPorEmailEValidarSenha() {
        Optional<Usuario> usuarioOpcional = usuarioRepository.findByEmail("login@teste.com");
    ...
    void naoEncontrarUsuarioPorEmailInexistente() {
        Optional<Usuario> usuarioOpcional = usuarioRepository.findByEmail("errado@teste.com");
